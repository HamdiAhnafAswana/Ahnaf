...
public class Toko_Skincare extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Nama_Barang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Skin Normal", "Skin Elite", "Skin Epic", "Skin Colector", "Skin Legend" }));
    ...
    private void Nama_BarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Nama_BarangActionPerformed
        ...
        switch(NamaBarang){
            case "Skin Normal":
            Harga_Barang.setText("50000");
            break;
            case "Skin Elite":
            Harga_Barang.setText("75000");
            break;
            case "Skin Epic":
